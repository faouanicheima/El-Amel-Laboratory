 ...
 <span class="dashboard">patient</span>
      ...
      <div class="overview-boxes">
         <table>
                ...
                <?php
           $query = 'SELECT p.idPatient, p.nomP, p.prénomP, p.télP, p.datenaissP , p.emailP, COUNT(r.idPatient) as numRDV FROM patient p LEFT JOIN rendez_vous r ON p.idPatient = r.idPatient GROUP BY p.idPatient';
          $q = $conn->query($query);
